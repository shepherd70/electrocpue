...
reach × species summary with a confidence interval on density. The reported
density is a random-effects pooled geometric mean, and its interval combines
each survey's method-aligned likelihood uncertainty with between-survey
variation on the log scale. A reach is flagged `weak`
